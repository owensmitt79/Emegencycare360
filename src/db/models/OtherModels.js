...
Consultation.belongsTo(User, { foreignKey: 'patient', as: 'patientUser', onDelete: 'CASCADE' });

Doctor.hasMany(Consultation, { foreignKey: 'doctorId', as: 'consultations', onDelete: 'CASCADE' });
Consultation.belongsTo(Doctor, { foreignKey: 'doctor', as: 'doctorProfile', onDelete: 'CASCADE' });
